...
- названия быстрых фильтров в согласованном интерфейсе —
  `Все / В тарифе / Не тарифицируется`.
...
В ветке handoff нет `vendor`, локальной копии UI Kit и бинарных артефактов
preview-версии.
...
таблицы тарифов. Для проверки доступны оба тарифа; перед production-интеграцией
